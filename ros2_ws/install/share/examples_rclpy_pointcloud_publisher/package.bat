...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclpy_pointcloud_publisher\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclpy_pointcloud_publisher\hook\ament_prefix_path.bat"
