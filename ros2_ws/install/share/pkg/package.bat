...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\pkg\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\pkg\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/pkg/local_setup.bat"
