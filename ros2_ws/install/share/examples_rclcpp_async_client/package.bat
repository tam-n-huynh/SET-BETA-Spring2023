...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_async_client\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_async_client\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/examples_rclcpp_async_client/local_setup.bat"
