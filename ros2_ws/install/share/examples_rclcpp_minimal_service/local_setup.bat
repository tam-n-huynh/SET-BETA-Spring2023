...
set "AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_minimal_service]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_minimal_service] "%AMENT_CURRENT_PREFIX%\share\examples_rclcpp_minimal_service\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_minimal_service] "%AMENT_CURRENT_PREFIX%\share\examples_rclcpp_minimal_service\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_minimal_service]:;=";"%") do (
    call:call_file %%f
  )
