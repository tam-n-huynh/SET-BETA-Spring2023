...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_service\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_service\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/examples_rclcpp_minimal_service/local_setup.bat"
