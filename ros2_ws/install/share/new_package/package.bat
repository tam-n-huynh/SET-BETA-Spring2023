...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\new_package\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\new_package\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/new_package/local_setup.bat"
