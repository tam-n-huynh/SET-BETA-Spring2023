...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclpy_minimal_action_server\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclpy_minimal_action_server\hook\ament_prefix_path.bat"
