...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_action_server\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_action_server\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/examples_rclcpp_minimal_action_server/local_setup.bat"
