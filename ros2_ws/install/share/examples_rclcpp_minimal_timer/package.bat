...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_timer\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_minimal_timer\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/examples_rclcpp_minimal_timer/local_setup.bat"
