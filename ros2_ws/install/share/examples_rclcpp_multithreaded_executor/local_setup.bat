...
set "AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_multithreaded_executor]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_multithreaded_executor] "%AMENT_CURRENT_PREFIX%\share\examples_rclcpp_multithreaded_executor\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_multithreaded_executor] "%AMENT_CURRENT_PREFIX%\share\examples_rclcpp_multithreaded_executor\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[examples_rclcpp_multithreaded_executor]:;=";"%") do (
    call:call_file %%f
  )
