...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_multithreaded_executor\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\examples_rclcpp_multithreaded_executor\hook\pythonpath.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share/examples_rclcpp_multithreaded_executor/local_setup.bat"
