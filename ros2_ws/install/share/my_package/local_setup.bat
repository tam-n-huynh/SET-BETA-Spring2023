...
set "AMENT_ENVIRONMENT_HOOKS[my_package]="

:: these are the environment hooks of this package
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_package] "%AMENT_CURRENT_PREFIX%\share\my_package\environment\ament_prefix_path.bat"
call:ament_append_value AMENT_ENVIRONMENT_HOOKS[my_package] "%AMENT_CURRENT_PREFIX%\share\my_package\environment\path.bat"
...
if not defined AMENT_RETURN_ENVIRONMENT_HOOKS (
  ...
  for %%f in ("%AMENT_ENVIRONMENT_HOOKS[my_package]:;=";"%") do (
    call:call_file %%f
  )
