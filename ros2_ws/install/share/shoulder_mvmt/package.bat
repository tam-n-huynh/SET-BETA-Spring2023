...
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\shoulder_mvmt\hook\cmake_prefix_path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\shoulder_mvmt\hook\path_dll.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\shoulder_mvmt\hook\path.bat"
call:call_file "%%COLCON_CURRENT_PREFIX%%\share\shoulder_mvmt\hook\pythonpath.bat"
